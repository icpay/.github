...
- **icpay-widget** — Embeddable payment widgets (Web Components + React wrappers)
  - Components: `pay-button`, `amount-input`, `premium-content`, `tip-jar`, `article-paywall`, `coffee-shop`, `donation-thermometer`, `progress-bar`
  - Framework-agnostic, themable via CSS variables; ships React bindings
  - Uses `@ic-pay/icpay-sdk` under the hood
  - Repo: https://github.com/icpay/icpay-widget
...
- Repositories:
  - SDK: https://github.com/icpay/icpay-sdk
  - Widget: https://github.com/icpay/icpay-widget
  - Docs: https://github.com/icpay/icpay-docs
